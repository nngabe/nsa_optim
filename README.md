...
```
Write code for training LLMs from scratch using https://github.com/fla-org/native-sparse-attention.git, https://github.com/NVIDIA-NeMo/Emerging-Optimizers.git, and https://github.com/huggingface/peft.git. I want to train many different models comparing different architectures and optimizers:
